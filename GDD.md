...
The player will start with zero cards and money. They must duel a common enemy first in a match with an empty hand.  After this first battle, a procedually generated map will be shown, where the player must weigh their decisions to what benefits them the most; having a duel or not, facing the boss headfirst or risk a duel beforehand to get more cards and money, prioritize card collection for a next run. If the player dies during a duel, they will lose all of their cards and be able to keep half of their coins. 
...
3. The player must choose the target of the current card on top of the deck; either themselves to get an extra turn in the case it is a sun card or the enemy to inflict damage in case its a moon card.
...
At first, the sense of chance is big, but after the first round of the first duel, each character card will introduce slowly the idea of planning and thinking befor playing their cards to the player. This will let the player slowly understand the slight gambling element, while introducing the ways in which they could save themselves and punish the enemy, and viceversa from the enemy's side.

Since you are "The Fool", the world must feel unknown, amuzing and dreadful all at once, where the player does not know all cards, but after every victory and defeat the player will get a lesson about how the character cards, world, and map works.
