...
| User Story \#9 | Accesibility elements implementation |
| :---- | :---- |
| As a player, I want to be able to play even if I have a disability. |  |
| The webpages have alt and aria-label attributes, so they are well detected by screen readers. | *Priority:* Medium *Time Estimation:* 0.5h |
...
| User Story \#40 | Descent Warnings |
| :---- | :---- |
| As a player, I want to make sure that when I click on something that I wasn't intended too I get an alert.  |  |
| A "No Previous Descent" alert will appear when I click "Continue Descent" but I don't have a previous one. | *Priority:* Low *Time Estimation:* 2h |
